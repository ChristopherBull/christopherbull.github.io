---
layout: single
title: <i class="fas fa-chalkboard fa-fw headingIcon" aria-hidden="true"></i>Course History
...
An overview of the modules I am currently teaching, have taught, or have contributed to in lecturing, lab, and guest-teaching roles. For the underlying teaching philosophy and approach, see the [Teaching overview](/teaching/).
...
- "Masterclass &mdash; DevOps and Continuous Integration" (SCC.330) _[2020]_
...
- **Code First: Girls** &mdash; Introduction to Web Development (evening classes) _[2018]_
