...
flowchart LR
    ...
    subgraph T["Research Themes"]
        direction TB
        D[<i class="fas fa-heart-pulse fa-fw"></i><br>Digital Health Interventions & Behaviour Change] ~~~
        I[<i class="fas fa-vr-cardboard fa-fw"></i><br>Interactive & Immersive Systems] ~~~
        M[<i class="fas fa-chart-line fa-fw"></i><br>Digital Measures of Health & Wellbeing] ~~~
        S[<i class="fas fa-people-arrows fa-fw"></i><br>Health Systems, Communities & Infrastructure] ~~~
        E[<i class="fas fa-laptop-code fa-fw"></i><br>Human Factors of SE & Computing Education]
    end
...
### <i class="fas fa-heart-pulse fa-fw headingIcon"></i>Digital Health Interventions &amp; Behaviour Change
...
### <i class="fas fa-vr-cardboard fa-fw headingIcon"></i>Interactive &amp; Immersive Systems
...
### <i class="fas fa-chart-line fa-fw headingIcon"></i>Digital Measures of Health &amp; Wellbeing
...
### <i class="fas fa-people-arrows fa-fw headingIcon"></i>Health Systems, Communities &amp; Infrastructure
...
### <i class="fas fa-laptop-code fa-fw headingIcon"></i>Human Factors of Software Engineering &amp; Computing Education
