---
layout: single
title: <i class="fas fa-users fa-fw headingIcon" aria-hidden="true"></i>PhD Supervision
...
Name
Research Topic
[ Theme icons ] | [ Method icons ] | [ Context icons ] | [ Optional co-supervisor tag ] -->
...
- Social Media Analysis: fa-hashtag
- Behaviour Change / Engagement: fa-arrows-spin
- Multimodal Sensing / Biomarkers: fa-wave-square
- Data Visualisation / Analytics: fa-chart-area
- Evaluation / Field Trials: fa-clipboard-check
- Ethics / Governance: fa-scale-balanced
- Sustainability / Net Zero: fa-leaf

Context icons:
- Clinical: fa-stethoscope
- Community: fa-users
- Education: fa-graduation-cap
- Home / Everyday Life: fa-house-user
- Operating Theatre / Surgical: fa-user-nurse
- Public Health: fa-globe-europe

Supervision:
- Primary supervisor: (default – no icon shown)
